...
df_DISPATCH_UNIT_SCADA = pd.read_csv(os.path.join(mmsdm_dir, 'PUBLIC_DVD_DISPATCH_UNIT_SCADA_201912010000.CSV'),
                                     skiprows=1, skipfooter=1, engine='python')
...
df_DISPATCH_UNIT_SCADA_agg.to_csv(os.path.join(output_dir, 'signals_dispatch_new.csv'))
...
"""df_TRADINGREGIONSUM = pd.read_csv(os.path.join(data_dir, 'AEMO', 'MMSDM', 'PUBLIC_DVD_TRADINGREGIONSUM_201706010000.CSV'),
                                  skiprows=1, skipfooter=1, engine='python')"""
df_TRADINGREGIONSUM = pd.read_csv(os.path.join(data_dir, 'AEMO', 'MMSDM', 'PUBLIC_DVD_TRADINGREGIONSUM_201912010000.CSV'),
                                  skiprows=1, skipfooter=1, engine='python')
...
df_TRADINGREGIONSUM_piv.to_csv(os.path.join(output_dir, 'signals_regional_load_new.csv'))

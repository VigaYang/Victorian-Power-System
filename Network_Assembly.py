...
plt.savefig('/Users/yangweijia/Documents/Python/Master Dissertation Simulation/Pandapower Open Grid/Assemble_1.png',dpi=600,bbox_inches = 'tight')
plt.show()
...
# Find length of each line (in kilometres) Price
...
plt.savefig('/Users/yangweijia/Documents/Python/Master Dissertation Simulation/Pandapower Open Grid/Assemble_2.png',dpi=600,bbox_inches = 'tight')
plt.show()
...
gdf_v.plot(cmap='Blues')
plt.savefig('/Users/yangweijia/Documents/Python/Master Dissertation Simulation/Pandapower Open Grid/Assemble_3.png',dpi=600,bbox_inches = 'tight')
plt.show()
...
#Population
gdf_vor.to_csv(os.path.join(output_dir, 'Voronoi_Population_Intersection.csv'))
gdf_u.to_csv(os.path.join(output_dir, 'unary_union polygons.csv'))
